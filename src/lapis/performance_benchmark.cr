...
module Lapis
  ...
  class PerformanceBenchmark
    ...
    def benchmark_with_memory(name : String, &block)
    ...
    def benchmark_file_operation(operation : String, file_path : String, &block)
    ...
    def benchmark_template_rendering(template_name : String, content_count : Int32, &block)
    ...
    def benchmark_build_phase(phase : String, &block)
